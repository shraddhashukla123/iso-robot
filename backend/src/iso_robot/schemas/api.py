...
class ScoreRisksRequest(BaseModel):
    ...
    controls: list[str] | None = None   # optional explicit controls; else uses the register
...
class RiskAssessmentResponse(BaseModel):
    ...
    created_at: str
    assessment: dict   # full structure incl. inherent/residual/response + per-control detail   


class AssignControlsRequest(BaseModel):
    control_ids: List[str]


class AssignControlsResponse(BaseModel):
    issue_id: str
    assigned: int 
