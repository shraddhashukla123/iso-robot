...
| `risk_tagging` | `POST /risk-tagging/run` | `risk_tags` recommendations (process / function / KPI / region / control family) |
| `risk_owner_assignment` | `POST /risk-assignments/run` | `risk_assignments` owner recommendations with alternates |
